					...
					<tbody> <?php
						...
						// Pagination settings
						    ...
						    // Fetch staffs data from the database
						     $sql = "SELECT * FROM funds WHERE category = " . $_SESSION['disability'] . " LIMIT $offset, $recordsPerPage";
                ...
                <div class="modal-body">					
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="form-control" required>
                            ...
                            <option value="1">Intellectual Disabled</option>
                        </select>
                    </div>
                    <!-- Reward (Amount) -->
                    <div class="form-group">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control" required>
                                ...
                                <option value="1" <?php echo ($row["category"] == 'Intellectual Disabled') ? 'selected' : ''; ?>>Mentally Disabled</option>
                                <!-- Add more options if needed -->
                            </select>
                        </div>
                        <div class="form-group">
