...
<body>
    ...
    <!-- Left Panel -->
    <?php $page="dashboard"; include 'menu.php';?>
    <!-- /#left-panel -->
    <!-- Right Panel -->
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center"><b>TASKS | FUNDS </b></h3>
                            </div>
               ...
               <div class="col-sm-6 col-lg-3">
                            <?php
                                ...
                                $claimed = mysqli_query($conn, $query); 

                                if ($claimed) 
                                { 
                                 // it return number of rows in the table. 
                                 $row_claimed = mysqli_num_rows($claimed); 
                            ...
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        ...
                                        <!-- <span class="count"><?php echo $row_claimed;?></span> -->
                                    </h3>
             ...
             <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Claimed Tasks</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM mytasks WHERE completion_status = 0 AND user_id = ?";
                 ...
                 <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_pending;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Pending Tasks</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <?php
                            ...
                            $user_id = $_SESSION['user_id'];
                            $query = "SELECT * FROM mytasks WHERE completion_status = 1 AND user_id = ?";
                            $stmt = mysqli_prepare($conn, $query);

                            if ($stmt) {
                                mysqli_stmt_bind_param($stmt, "i", $user_id);
                                mysqli_stmt_execute($stmt);
                                $complete = mysqli_stmt_get_result($stmt);

                                if ($complete) {
                                    $row_complete = mysqli_num_rows($complete);
                                }
             ...
             <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_complete;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Completed Tasks</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                    ...
                    <?php
                                $query = "SELECT amount FROM funds WHERE category = " . $_SESSION['disability']; 
                                $paid = mysqli_query($conn, $query); 

                                if ($paid) { 
                                    $row_paid = mysqli_fetch_assoc($paid);
                                    $amount = $row_paid['amount'];
                                }
                                ?>
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $amount;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">PWD FUND(Ksh)</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
