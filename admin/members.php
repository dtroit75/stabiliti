		...
		<div class="table-responsive">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>View <b>Members With Disabilities</b></h2>
						</div>
						<div class="col-xs-6">
						    ...
						    ?>
						            <tr>
						                ...
						                <td><?php echo $row["education"]; ?></td>
						                 ...
						                 <td>
						                     <a href="#approveUserModal<?php echo $row["user_id"]; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Approve">&#xE254;</i></a>
...
while($row = $result->fetch_assoc()) {
    ...
    <div id="approveUserModal<?php echo $row["user_id"]; ?>" class="modal fade">
            ...
            <div class="modal-content">
                <form action="staff.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Confirm Approval of this record?</p>
                        <p class="text-warning"><small></small></p>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                        <input type="submit" class="btn btn-success" name="approve_user" value="Approve">
                    </div>
                </form>
            </div>
        </div>
