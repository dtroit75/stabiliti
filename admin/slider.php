...
<body>
	...
	<div id="slider">
		<div class="ws_images">
			<ul>
				<li><img src="images/img1.jpg" alt="Every Talent Counts" title="Every Talent Counts" id="wows1_3"/></li>
				<li><img src="images/img5.jpg" alt="registration invites plenty opportunities" 
					 title="registration invites plenty opportunities" id="wows1_0"/></li>
				<li><img src="images/img3.jpeg" alt="Abilities Define, Not Limits" title="Abilities Define, Not Limits" id="wows1_1"/></li>
				<li><img src="images/slider_pool.jpg" alt="pick jobs from pool" title="pick jobs from pool" id="wows1_2"/></li>
				<li><img src="images/img2.jpg" alt="Strength in Differences" title="Strength in Differences: Offer Opportunities, Spark Change" id="wows1_4"/></li>
	...
	<script type="text/javascript" src="js1/wowslider.js"></script>
