            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center"><b>PWD | MANAGER </b></h3>
                            </div>
             ...
             <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_total;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Total Members</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                            ...
                            <?php
                                $query = "SELECT * FROM user_list WHERE  employment = 'employed'";  
                                $employed = mysqli_query($conn, $query); 

                                if ($employed) 
                                { 
                                 // it return number of rows in the table. 
                                 $row_employed = mysqli_num_rows($employed); 
                 ...
                 <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_employed;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Employed</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                    ...
                    <?php
                                $query = "SELECT * FROM user_list WHERE employment = 'not_employe' "; 
                                $not_employed = mysqli_query($conn, $query); 

                                if ($not_employed) 
                                { 
                                 // it return number of rows in the table. 
                                 $row_not_employed = mysqli_num_rows($not_employed); 
                        ...
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_not_employed;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Unemployed</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
                                ...
                                { 
                                 // it return number of rows in the table. 
                                 $row_tasks = mysqli_num_rows($tasks); 
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?php echo $row_tasks;?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Total Tasks</p><!-- Log on to codeastro.com for more projects! -->
                                </div><!-- /.card-left -->
